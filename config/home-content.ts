...
export const homePricing = [
  {
    ...
    features: [
      "1-3 pages with conversion-first structure",
  ...
  },
  {
    ...
    timeline: "7-14 days",
    featured: true,
    bestFor: "Best for established businesses that need regular inquiries",
    features: [
      "Up to 8 strategic pages",
  ...
  },
  {
    ...
    price: "RM6,500+",
    timeline: "14-21 days",
    bestFor: "Best for brands that need custom UX and automation",
    features: [
      "Custom components",
      "Portfolio/case modules",
  ...
  },
  {
    ...
    price: "Custom Quote",
    timeline: "Custom",
    bestFor: "Best for multi-branch or advanced integration needs",
    features: [
