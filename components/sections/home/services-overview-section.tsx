...
export function ServicesOverviewSection() {
  return (
    <Section
      ...
      className="relative mt-16 overflow-visible bg-gradient-to-b from-primary/5 to-transparent py-0 dark:from-primary/10"
    >
      <ShortInfo />
      <Container className="space-y-12">
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="text-primary">launch</span>, rank, and convert.
            </>
          }
            ...
            return (
              <FadeUp key={index} delay={index * 0.04}>
                <Card className="flex h-full flex-col rounded-lg border border-border/50 bg-card p-8 shadow-sm transition-colors hover:border-primary/20 dark:bg-slate-900/70">
                  <div
                    className={cn(
                      "mb-6 flex h-14 w-14 items-center justify-center rounded-xl ring-1 ring-black/5 dark:ring-white/10",
                      iconBg,
                    )}
                  >
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    Proactive digital execution that keeps your website, SEO,
                    and lead flow optimized without interruption.
                  </p>
                </Card>
              </FadeUp>
            );
          ...
          <FadeUp delay={0.2}>
            <Card className="flex h-full flex-col justify-center rounded-lg bg-[#0d1e4c] p-8 text-white shadow-md border-transparent">
              ...
              <p className="text-slate-300 text-sm mb-8 leading-relaxed">
                Discover our complete range of IT solutions designed to improve
                security, efficiency, and business growth.
              </p>
              <Button
                asChild
                className="w-fit bg-white text-[#0d1e4c] hover:bg-slate-100"
              >
                <Link href="/services">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Button
            asChild
            className="mx-auto mt-8 bg-primary text-white hover:bg-primary/90"
          >
